...
* The goal of this project is to investigate the capability of Deep Learning Models to reproduce sentiment analysis scores produced by the NLTK package's **"Vader Sentiment Intensity Analyzer()".**
